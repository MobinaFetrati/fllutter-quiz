...
import 'data_olom.dart';
import 'package:flutter_quiz/data/question.dart';
import 'result_olom.dart';

class QuizPageOlom extends StatefulWidget {
  const QuizPageOlom({super.key});

  @override
  State<QuizPageOlom> createState() => _QuizPageOlomState();
}

class _QuizPageOlomState extends State<QuizPageOlom> {
  int ShownQ = 0;
  Question? selectedQ;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              CircleAvatar(
                  backgroundImage: AssetImage('images/olom.png'), radius: 50),
              SizedBox(height: 30),
              Text(
                selectedQ!.QTitle!,
