...
import 'data_omomi.dart';
import 'package:flutter_quiz/data/question.dart';
import 'result_omomi.dart';

class QuizPageOmomi extends StatefulWidget {
  const QuizPageOmomi({super.key});

  @override
  State<QuizPageOmomi> createState() => _QuizPageOmomiState();
}

class _QuizPageOmomiState extends State<QuizPageOmomi> {
  int ShownQ = 0;
  Question? selectedQ;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              CircleAvatar(
                  backgroundImage: AssetImage('images/omomi.png'), radius: 50),
              SizedBox(height: 30),
              Text(
                selectedQ!.QTitle!,
