...
import 'data_tarikh.dart';
import 'package:flutter_quiz/data/question.dart';
import 'result_tarikh.dart';

class QuizPageTarikh extends StatefulWidget {
  const QuizPageTarikh({super.key});

  @override
  State<QuizPageTarikh> createState() => _QuizPageTarikhState();
}

class _QuizPageTarikhState extends State<QuizPageTarikh> {
  int ShownQ = 0;
  Question? selectedQ;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              CircleAvatar(
                  backgroundImage: AssetImage('images/tarikh.png'), radius: 50),
              SizedBox(height: 30),
              Text(
                selectedQ!.QTitle!,
