...
import 'data_football.dart';
import 'package:flutter_quiz/data/question.dart';
import 'result_football.dart';

class QuizPageFootball extends StatefulWidget {
  const QuizPageFootball({super.key});

  @override
  State<QuizPageFootball> createState() => _QuizPageFootballState();
}

class _QuizPageFootballState extends State<QuizPageFootball> {
  int ShownQ = 0;
  Question? selectedQ;
